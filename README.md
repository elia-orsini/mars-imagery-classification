...
Therefore, to have the most efficient model I had to modify and train a portion of it with the dataset of images from Mars. Furthermore, to prevent the network from overfitting, I added some extra-layers which for example randomly flipped or rotated images. The results I was able to get are displayed in Table 2 and they represent an increase in the performances  compared to the model previously used by Wagstaff et. al. (2018).
